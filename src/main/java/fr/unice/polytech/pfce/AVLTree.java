...
/**
 * Credits : https://github.com/justinethier/AVL-Tree/blob/master/src/main/java/justinethier/AvlTree.java
 *
 ...
 */
class AVLTree<T extends Comparable<? super T>> implements BinaryTree<T> {
    /**
